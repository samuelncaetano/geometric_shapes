...
import pytest
from src.package import Point, LineSegment, Circle, Rectangle, Triangle, GeometricShapeController, InMemoryRepository
...
def test_adicionar_forma_geometrica(
    ...
    assert [ponto, reta, circulo, retangulo,
            triangulo] == repository.list_all()
